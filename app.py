...
def main():
    ...
    if submitted:
        # Predict state and create new trade entry
        ...
        # Retrieve the updated row to ensure correct data types
        updated_row = st.session_state.trades.iloc[-1]

        # Prepare data for Google Sheets (convert to Python types)
        trade_list = [
    ...
    if not st.session_state.trades.empty:
        ...
        # Style and display recent trades
